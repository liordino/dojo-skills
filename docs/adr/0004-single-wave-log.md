...
- **Status:** accepted
- **Date:** 2026-08-31
- **Context:** the per-wave durable writes were duplicated — `progress.md` and HANDOFF's
  ...
  snapshot purpose.
- **Decision:**
  - `progress.md` is the single append-only per-wave log. HANDOFF.md drops Wave History
