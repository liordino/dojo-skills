...
2026-08-31 | artifact-diet | refactor | progress.md = the single per-wave log (HANDOFF Wave History migrated + pointer); briefs supervised-only; debrief 5→3 fields; hajime/kaizen/kata-commit/manual/README updated; ADR 0004; s1-assert rewritten same-wave | write targets ~8→5; HANDOFF stops growing | (this commit)
