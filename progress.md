...
2026-08-31 | site-parity | docs | canonical cycle rendering everywhere (README/CONTEXT/site/HANDOFF); site name-grid + install shorthand + artifact lists (+findings.md) + meta description; README links the live site; MANUAL §5b final numbers; CHANGELOG v1.3.0 | one rendering, one artifact list, one install form | (this commit)
