...
R11_CLASSIFY='randori:user kaizen:user kan:user tanren:user kensha:user kokai:user dojo-principles:session dojo-project:session dojo-conduct:session kata-red:model kata-green:model kata-commit:model hajime:model hajime-bugfix:model'
...
R12_SKILLS='dojo-principles|dojo-project|dojo-conduct|hajime-bugfix|hajime|randori|kan|tanren|kaizen|kokai|kensha|kata-red|kata-green|kata-commit'
